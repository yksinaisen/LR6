...
#### Пункт 15: История операций в форматированном виде

Получена история коммитов в формате: сокращенный хэш + дата + комментарий + автор

![История коммитов](screenshots/17-formatted-history-command.png)
